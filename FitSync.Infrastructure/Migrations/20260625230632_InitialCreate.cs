        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CargaUtilizada = table.Column<float>(type: "real", nullable: false),
                    RepeticoesUtilizadas = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Progressos_Exercicios_ExercicioId",
                        column: x => x.ExercicioId,
                        principalTable: "Exercicios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Progressos_Usuarios_AlunoId",
                        column: x => x.AlunoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Progressos_ExercicioId",
                table: "Progressos",
                column: "ExercicioId");
